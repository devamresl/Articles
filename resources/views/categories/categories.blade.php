						...
						<div class="blog-box grid-style">
							<div class="row">
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c1.jpg" alt="">
										</div>
								...
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c2.jpg" alt="">
										</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c4.jpg" alt="">
										</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c5.jpg" alt="">
										</div>
										<a class="text-link" href="#">Lifestyle</a>
										<h2><a href="single-post.html">Cras iaculis ultricies nulla.</a></h2>
										<ul class="post-tags">
								...
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c6.jpg" alt="">
										</div>
										<a class="text-link" href="#">Lifestyle</a>
										<h2><a href="single-post.html">Cras iaculis ultricies nulla.</a></h2>
										<ul class="post-tags">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="news-post article-post">
										<div class="image-holder">
											<img src="upload/blog/c7.jpg" alt="">
										</div>
										<a class="text-link" href="#">Food</a>
										<h2><a href="single-post.html">Nullam malesuada eratut turpis.</a></h2>
										<ul class="post-tags">
								...
								<div class="col-md-6">
									<div class="news-post article-post">
										...
										<a class="text-link" href="#">Travel</a>
										<h2><a href="single-post.html">Morbi in sem quisdui placerat.</a></h2>
										<ul class="post-tags">
											<li>3 days ago</li>
											<li><a href="#">3 comments</a></li>
											<li>by <a href="#">John Smith</a></li>
					...
					<div class="col-lg-4">
						<div class="sidebar">
							...
							<div class="widget category-widget">
								...
								<ul class="category-list">
									...
									<li>
                                        ...
                                        <button class="btn btn-primary btn-sm ml-2 float-right">
                                            <a href="{{ route('categories.edit', $category->id) }}" style="color: #fff">Edit</a>
                                        </button>
                                        {{-- <a href="" style="color: #ff0303"><i class="fa fa-trash-alt"></i></a> --}}
                                ...
                                <a href="categories/create" class="btn btn-sm btn-primary mt-3 float-right">Create New Category</a>
							</div>
